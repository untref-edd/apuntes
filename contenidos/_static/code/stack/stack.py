...
Este módulo proporciona una implementación de la estructura de datos pila (stack)
utilizando el principio LIFO (Last In, First Out - Último en entrar, primero en salir).

La pila es una estructura de datos lineal que permite insertar y eliminar elementos

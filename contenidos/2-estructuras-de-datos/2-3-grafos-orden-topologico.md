...
```{figure} ../_static/figures/2-estructuras-de-datos/2-3-grafos-orden-topologico/grafo_orden_topologico_light.svg
---
class: only-light-mode
width: 80%
---
...
```{figure} ../_static/figures/2-estructuras-de-datos/2-3-grafos-orden-topologico/grafo_orden_topologico_dark.svg
---
class: only-dark-mode
width: 80%
---

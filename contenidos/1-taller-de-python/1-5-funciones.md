...
- [Tutorial de Python - Funciones](https://docs.python.org/es/3/tutorial/controlflow.html#defining-functions)
- [Python Functions (W3Schools)](https://www.w3schools.com/python/python_functions.asp)
- [Python Lambda Functions (W3Schools)](https://www.w3schools.com/python/python_lambda.asp)
- [Python Iterators (W3Schools)](https://www.w3schools.com/python/python_iterators.asp)
- [Funciones Decoradoras (Hektor Profe)](https://hektorprofe.github.io/python/funcionalidades-avanzadas/funciones-decoradoras/)
- [Funciones Lambda (Hektor Profe)](https://hektorprofe.github.io/python/funcionalidades-avanzadas/funciones-lambda/)
- [Funciones Generadoras (Hektor Profe)](https://hektorprofe.github.io/python/funcionalidades-avanzadas/funciones-generadoras/)
- [Función Filter (Hektor Profe)](https://hektorprofe.github.io/python/funcionalidades-avanzadas/funcion-filter/)
- [Función Map (Hektor Profe)](https://hektorprofe.github.io/python/funcionalidades-avanzadas/funcion-map/)
